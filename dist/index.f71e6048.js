...
addItemBtn.addEventListener("click", (e)=>{
    ...
    if (text != "" && color != "") {
        const newItem = new (0, _itemDefault.default)(text, color, allCardsList[0].elements.items, id);
        newItem.render();
...
addCardBtn.addEventListener("click", ()=>{
    const newCard = new (0, _cardDefault.default)();
    newCard.render();
...
container.addEventListener("dragover", (e)=>{
    if (e.target.className == "cards__card") e.preventDefault();
});
...
},{"./components/card":"J4A7r","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./components/item":"ec1xx"}],"J4A7r":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"ec1xx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
function Item(text, color, parentObj, id) {
    this.text = text;
    this.color = color;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["foMn7","8VGZO"], "8VGZO", "parcelRequire94c2")
